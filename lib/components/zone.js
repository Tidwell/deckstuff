...
Zone.prototype.removeZone = function(id) {
	if (this.zones[id]) { delete this.zones[id]; }
};
Zone.prototype.removeZones = function() {
	var id;
	for (id in this.zones) {
		this.removeZone(id);
	}
};
...
Zone.prototype.removeStack = function(id) {
	if (this.stacks[id]) { delete this.stacks[id]; }
};
Zone.prototype.removeStacks = function() {
	var id;
	for (id in this.stacks) {
		this.removeStack(id);
	}
};
